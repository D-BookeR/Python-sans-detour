...
fen_principale.geometry("500x300")
cadre = tkinter.Frame(fen_principale, bg="red")
for ind in range(5):
...
cadre = tkinter.Frame(fen_principale, bg="blue")
for ind in range(8):
...
cadre = tkinter.Frame(fen_principale, bg="green")
for ind in range(6):
